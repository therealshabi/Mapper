...
public class GovtOrg extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logos.put("Airports Authority of India", getDrawable(R.drawable.airport_authority_of_india));
        ...
        logos.put("Archaeological Survey of India", getDrawable(R.drawable.archaeological));
        ...
        logos.put("Aadhaar", getDrawable(R.drawable.aadhar));
        ...
        logos.put("Swatch Bharat Abhiyan", getDrawable(R.drawable.swatch));
